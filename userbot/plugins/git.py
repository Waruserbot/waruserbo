...
async def source(e):
    ...
    await edit_or_reply(
        e,
        "Click [here](https://github.com/xAbhish3k/Waruserbot) to open this bot source code\
        \nClick [here](https://github.com/xAbhish3k/Waruserbot) to open supported link for heroku",
    )
